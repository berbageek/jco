                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" action="{{ route('project.update', $project) }}">
                            ...
                            <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="nama" type="text" class="form-control" name="nama" value="{{ old('nama', $project->nama) }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('client_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select name="client_id" class="form-control">
                                        ...
                                        <option value="{{ $id }}" {{ $id == old('client_id', $project->client_id) ? 'selected' : '' }}>{{ $client }}</option>
                                        @endforeach
                                    </select>
